...
(glyph band-A onarımı kapılı — MK-120.3, kaymalı Cadmatic export'larında çapaları açar).
...
| **K2** | Excel'de malzeme listesi **varsa** PDF ile karşılaştır; **yoksa** PDF'ten oluştur. Malzeme her hâlükârda PDF'ten okunmalı (L3 `malzeme_listesi` zaten var, kullanılmıyor) | ✓ | Katman 3-2c |
