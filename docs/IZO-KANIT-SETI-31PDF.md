...
## 160 NOTU (2026-06-06)
Kanıt setine dokunulmadı (160 = format yönetim mimarisi + spool modalı büyük ekranı; öğretim turu
yapılmadı). YENİ CANLI TEST YATAĞI: **NB1137 "ykjfytjk" taslağı** — E100-722-2015 + E100-722-2016
aileleri, 6 spool + 2 montaj çizimi (her biri 3 spool'a bağlı), 1 BOM Excel (IFS Malzeme
Listesi_Rev0.xlsx). Spool modalı / viewer / kalem-ekleme / Excel-kipi testleri bu taslakta yapılıyor
