...
> ## ⚠ TAZELİK DURUMU (132'de eklendi — önce bunu oku)
>
> Bu dosya **MK-74.x'e kadar düzenli, sonra durdu.** Aralık gerçeği:
> - **≤ MK-74.x + tek KARAR-95.1:** burada, kanonik.
> - **MK-96 / 98 / 99 / 101 / 108 / 110–131 (onlarca karar):** burada **YOK.** Bu dönemde kararlar
>   thematic doc'lara (`docs/PARSER-VE-YUKLEME-AKISI.md` Bölüm 9 MK haritası,
>   `docs/DEVRE-WIZARD-OMURGA.md`) + `.github/son-durum.md` + Claude hafızasına yazıldı.
> - **132'den itibaren** kararlar yeniden burada toplanmaya başladı (aşağıda MK-132.x).
>
> **Sonuç:** 75–131 arası bir MK arıyorsan önce ilgili thematic doc'a bak; burada bulamazsan
> eksik demek değil, **başka yere yazılmış** demek. Bu dosyayı 74-dönemi kanon sanma — bu, 132'de
> bizi 4 tur yanlış teşhise sürükleyen "bayat doküman" tuzağının ta kendisi (bkz. MK-132.1).
>
> **Geri-doldurma (75→131) bilinçli ERTELENDİ:** 2-3 oturumluk iş, kaynaklar dağınık, yanlış
> yeniden-kurma riski yüksek (131'in MK adayları yanlış çıktı). KARAR-95.1 mantığı: hayali kazanç
> peşinde koşma, YAGNI. Tetik: bir MK'yı thematic doc'ta bulamama 3+ kez tekrarlarsa, hedefli backfill.
